"""Regression checks for the lattice-algo-path-lab casebook."""
...
from casebook.harness import assert_expected, lattice_algo_path_lab_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(lattice_algo_path_lab_summary(), assert_expected())
